...
def main():
  ...
  if choice == "Home":
    ...
    st.text("PyGWalker is a straightforward Python library turning your Pandas dataframes into a visually interactive interface.")
    st.text("Seamlessly integrate it into your Streamlit app and make your data exploration as intuitive as using Tableau.")
